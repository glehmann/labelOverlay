...
\subfigure[Opacity=0.7, UseBackground=false (default), BackgroundValue=0 (default)]{\includegraphics[scale=0.5]{out-0_7}}
\subfigure[Opacity=0.7, UseBackground=true, BackgroundValue=0 (default)]{\includegraphics[scale=0.5]{OverlayUseBg}}
\subfigure[Opacity=0.7, UseBackground=true, BackgroundValue=176]{\includegraphics[scale=0.5]{OverlayUseBg176}}
